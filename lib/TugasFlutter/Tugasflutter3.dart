...
class TugasFlutter3 extends StatelessWidget {
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.count(
              ...
              mainAxisSpacing: 10,
              children: [
                _buildRegionCard("Citatah", "assets/images/arpam.jpg"),
                _buildRegionCard("Arpam", "assets/images/citatah.jpg"),
                _buildRegionCard("Parang", "assets/images/parang.jpg"),
              ],
            ),
          ],
        ),
  ...
  // Widget helper untuk card wilayah bergambar
  Widget _buildRegionCard(String cityName, String imagePath) {
    return Container(
      decoration: BoxDecoration(
